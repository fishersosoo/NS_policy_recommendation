...
from condition_identification.name_entity_recognition.vectorize import tokenization
from condition_identification.name_entity_recognition.vectorize.graph import optimize_graph
