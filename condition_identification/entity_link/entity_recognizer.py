...
if __name__ == "__main__":
    ...
    entity_set = (entity(name='营业收入', category='norm'), entity(name='纳税总额', category='norm'), entity(name='注册资本', category='norm'), entity(name='外资企业', category='category'), entity(name='外国非企业经济组织代表机构', category='category'), entity(name='内资企业', category='category'), entity(name='独立法人资格', category='qualification'), entity(name='世界1000强企业', category='qualification'), entity(name='中央大型企业', category='qualification'), entity(name='中国企业500强', category='qualification'), entity(name='中国民营企业500强', category='qualification'), entity(name='跨国公司', category='qualification'), entity(name='世界1000强', category='qualification'))
